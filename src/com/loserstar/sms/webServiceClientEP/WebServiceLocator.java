...
public class WebServiceLocator extends org.apache.axis.client.Service implements com.loserstar.sms.webServiceClientEP.WebService {
    ...
    public com.loserstar.sms.webServiceClientEP.WebServiceSoap getWebServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.loserstar.sms.webServiceClientEP.WebServiceSoap getWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.loserstar.sms.webServiceClientEP.WebServiceSoapBindingStub _stub = new com.loserstar.sms.webServiceClientEP.WebServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.loserstar.sms.webServiceClientEP.WebServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.loserstar.sms.webServiceClientEP.WebServiceSoapBindingStub _stub = new com.loserstar.sms.webServiceClientEP.WebServiceSoapBindingStub(new java.net.URL(WebServiceSoap_address), this);
                _stub.setPortName(getWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
